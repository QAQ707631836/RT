package com.wangmou.app.dws;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.wangmou.app.func.DimAsyncFunction;
import com.wangmou.bean.OrderWide;
import com.wangmou.bean.PaymentWide;
import com.wangmou.bean.ProductStats;
import com.wangmou.common.RTConstant;
import com.wangmou.utils.ClickHouseUtil;
import com.wangmou.utils.DateTimeUtil;
import com.wangmou.utils.MyKafkaUtil;
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<ProductStats> appraiseDS = commentInfoDStream.map(new MapFunction<String, ProductStats>() {
            ...
            public ProductStats map(String value) throws Exception {
                ...
                if (RTConstant.APPRAISE_GOOD.equals(jsonObject.getString("appraise"))) {
                    goodCommentCt = 1L;
                }
